...
class minIMU(LIS3MDL, LSM6DS33):
    ...
    def getAccelFil(self):
        ...
        self.accX = ((accels[0] - self.accX) * self.ALPHA_Accel_x) + self.accX
        self.accY = ((accels[1] - self.accY) * self.ALPHA_Accel_y) + self.accY
        self.accZ = ((accels[2] - self.accZ) * self.ALPHA_Accel_z) + self.accZ
